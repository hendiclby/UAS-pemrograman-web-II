...
<html>
  ...
  <body>
      ...
      <center>
      <form method="POST" action="proses_tambahkegiatan.php" enctype="multipart/form-data" >
      <section class="base">
        <div>
          <label>Jenis Kegiatan</label>
          <input type="text" name="jeniskegiatan" autofocus="" required="" />
        </div>
        <div>
    ...
    <input type="date" id="tanggalkegiatan" name="tanggalkegiatan" required="" />
        ...
        <div>
          ...
          <input type="text" name="pjkegiatan" autofocus="" required="" />
        </div>
        <div>
          <label>Gambar</label>
