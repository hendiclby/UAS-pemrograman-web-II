...
<body>
  ...
  <div class="content container mt-3">
    ...
    <!-- CRUD Table -->
    <center><button class="btn btn-success"><i class="fas fa-plus"></i><a  href="tambah_keuangan.php" style="color:#fff">Tambah</a></button>  
  ...
  ?>
       <tr>
          ...
          <td>
            <button class="btn btn-info"><i class="fas fa-edit"></i><a href="edit_keuangan.php?id=<?php echo $d['id']; ?>"style="color:#fff"> Edit </a></button>
            <button class="btn btn-danger"><i class="fas fa-trash"></i><a href="proses_hapuskeuangan.php?id=<?php echo $d['id']; ?>"style="color:#fff"> Hapus </a></button>
          </td>
      </tr>   
      <?php } ?>
    </tbody>
