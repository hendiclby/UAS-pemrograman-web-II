  ...
  if (isset($_GET['id'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='barang2.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='barang2.php';</script>";
  }         
  ?>
<!DOCTYPE html>
<html>
  ...
  <body>
      ...
      <center>
      <form method="POST" action="proses_editbarang.php" enctype="multipart/form-data" >
      <section class="base">
        ...
        <div>
         ...
         <input type="text" name="hargasatuan" value="<?php echo $data['hargasatuan']; ?>" />
        </div>
        <div>
          <label>Stok</label>
